...
async def test_find_all(user: User) -> None:
    @ui.page('/')
    def page():
        ui.button('button A')
        ui.label('label A')
...
async def test_find_kind(user: User):
    @ui.page('/')
    def page():
        ui.icon('home')
        ui.button('button A')
...
async def test_find_content(user: User):
    @ui.page('/')
    def page():
        ui.button('button A')
        ui.label('label A')
...
async def test_find_radio(user: User):
    @ui.page('/')
    def page():
...
async def test_find_toggle(user: User):
    @ui.page('/')
    def page():
...
async def test_find_select(user: User):
    @ui.page('/')
    def page():
...
async def test_find_within_marker(user: User):
    @ui.page('/')
    def page():
        ui.button('button A')
        ui.label('label A')
...
async def test_find_within_marker2(user: User):
    @ui.page('/')
    def page():
...
async def test_find_within_instance(user: User):
    @ui.page('/')
    def page():
        ui.button('button A')
        ui.label('label A')
...
async def test_find_within_kind(user: User):
    @ui.page('/')
    def page():
        ui.button('button A')
        with ui.row():
...
async def test_find_exclude_kind(user: User):
    @ui.page('/')
    def page():
        ui.button('button A')
        ui.label('label A')
...
async def test_find_exclude_marker(user: User):
    @ui.page('/')
    def page():
...
async def test_find_exclude_content(user: User):
    @ui.page('/')
    def page():
        ui.button('button A')
        ui.label('label A')
...
async def test_find_in_local_scope(user: User):
    @ui.page('/')
    def page():
        ui.button('button A')
        ui.label('label A')
