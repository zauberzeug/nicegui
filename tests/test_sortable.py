...
def test_sortable_drag_between_containers(screen: Screen):
    ...
    def page():
        ...
        with ui.sortable({'group': 'shared-group'}) as source_sortable:
            ui.label('Source Item 1').classes('draggable bg-blue-100')
            ui.label('Source Item 2').classes('draggable bg-blue-100')
            ui.label('Source Item 3').classes('draggable bg-blue-100')
        ...
        with ui.sortable({'group': 'shared-group'}) as target_sortable:
            ui.label('Target Item A').classes('draggable bg-green-100')
            ui.label('Target Item B').classes('draggable bg-green-100')
            ui.label('Target Item C').classes('draggable bg-green-100')
