...
def test_dev_mode(screen: Screen) -> None:
    ...
    screen.open('/')
    screen.selenium.find_element(By.XPATH, f'//script[@src="/_nicegui/{__version__}/static/vue.esm-browser.js"]')
...
def test_prod_mode(screen: Screen):
    ...
    screen.open('/')
    screen.selenium.find_element(By.XPATH, f'//script[@src="/_nicegui/{__version__}/static/vue.esm-browser.prod.js"]')
