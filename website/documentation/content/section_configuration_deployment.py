...
doc.text('', '''
    **Ways to protect your source code**
    ...
    If you want ot protect your code further instead of <a href="https://pyinstaller.org/en/v3.5/usage.html?highlight=encrypt#encrypting-python-bytecode">using `--key=key-string` argument on the command line of PyInstaller, you can use <a href="https://github.com/Nuitka/Nuitka">Nuitka</a> or <a href="https://cython.org/">Cython</a> to compile your python source code( *.py file) into Python extension( *.pyd file). However you must learn how to install and use a working C compiler firstly. Please check relevant websites or books. A minimal tutorial on how to implement on Windows OS with MingW64 is given in the following.
