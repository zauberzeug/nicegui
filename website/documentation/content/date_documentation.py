...
@doc.demo('Input element with date picker', '''
    ...
    [QMenu](https://quasar.dev/vue-components/menu)'s "auto-close" prop can be useful
    to automatically close the date picker once the date is selected.
    The "no-parent-event" prop can also be used to prevent a click within the text input itself to open the date picker.
