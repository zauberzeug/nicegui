...
class RefreshableDocumentation(UiElementDocumentation, element=ui.refreshable):
    ...
    def more(self) -> None:
        @self.add_markdown_demo('Refreshable UI with parameters', '''
        ...
        @self.add_markdown_demo('Refreshable UI for input validation', '''
        ...
        @self.add_markdown_demo('Refreshable UI with reactive state', '''
