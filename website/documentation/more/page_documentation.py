...
class PageDocumentation(UiElementDocumentation, element=ui.page):
    ...
    def more(self) -> None:
        @self.demo('Pages with Path Parameters', '''
        ...
        @self.demo('Wait for Client Connection', '''
        ...
        @self.demo('Modularize with APIRouter', '''
