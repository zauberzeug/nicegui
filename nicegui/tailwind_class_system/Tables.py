...
class Tables:
    ...
    def border_collapse(self, _border_collapse: BorderCollapse):
        """Utilities for controlling whether table borders should collapse or be separated."""
        self.__add(_border_collapse)
        return self

    def border_spacing(self, _border_spacing: BorderSpacing):
        """Utilities for controlling the spacing between table borders."""
        self.__add(_border_spacing)
        return self

    def table_layout(self, _table_layout: TableLayout):
        """Utilities for controlling the table layout algorithm."""
        self.__add(_table_layout)
        return self
