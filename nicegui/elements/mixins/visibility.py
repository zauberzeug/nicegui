...
class Visibility:
    visible = BindableProperty['Visibility', bool](
        on_change=lambda sender, visible: sender._handle_visibility_change(visible))  # pylint: disable=protected-access
    ...
    def _handle_visibility_change(self, visible: bool) -> None:
