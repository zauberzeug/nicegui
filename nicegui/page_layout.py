...
class Header(Element):
    ...
    def __init__(self, fixed: bool = True) -> None:
        ...
        code = list(self.client.layout.layout._props['view'])
        code[1] = 'H' if fixed else 'h'
        self.client.layout.layout._props['view'] = ''.join(code)
...
class Drawer(Element):
    ...
    def __init__(self, side: str, *, fixed: bool = True, top_corner: bool = False, bottom_corner: bool = False) -> None:
        ...
        self.layout._props['show-if-above'] = True
        self.layout._props['side'] = side
        self.layout._classes = ['q-pa-md']
        code = list(self.client.layout.layout._props['view'])
