...
def _check_current_slot(element_tag: str) -> None:
    parent = context.get_slot().parent
    if parent != parent.client.content:
        log.warning(f'Found top level layout element with tag "{element_tag}" inside element with tag "{parent.tag}".'
