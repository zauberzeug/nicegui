...
@dataclass(**KWONLY_SLOTS)
class EChartClickEventArguments(UiEventArguments):
    component_type: str


@dataclass(**KWONLY_SLOTS)
class EChartComponentClickEventArguments(EChartClickEventArguments):
    name: str | None


@dataclass(**KWONLY_SLOTS)
class EChartPointClickEventArguments(EChartClickEventArguments):
    name: str
    series_type: str
    series_index: int
    series_name: str
