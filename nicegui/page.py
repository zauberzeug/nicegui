...
class page:
    ...
    def __call__(self, func: Callable[..., Any]) -> Callable[..., Any]:
        ...
        async def decorated(*dec_args, **dec_kwargs) -> Response:
            request: Request = dec_kwargs['request']
            client_id_set_in_request = request.headers.get('X-NiceGUI-Client-ID')
            ...
            if client_id_set_in_request:
                return client.build_response(request, send_json=True, past_client_id=client_id_set_in_request)
