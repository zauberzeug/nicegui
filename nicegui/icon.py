...
APP_ID = f"nicegui.zauberzeug.version.{__version__}"
APP_ICON = os.path.abspath("nicegui/static/favicon.ico")


def set_app_icon(icon_path=APP_ICON):
    """
    Sets the application icon for the foreground window.

    Args:
        icon_path (str): The path to the icon file. Defaults to APP_ICON.
    ...
    Notes:
        - This function uses the Windows API to set the application icon.
        - The icon_path should be a valid path to an icon file.
        - If no icon_path is provided, it uses the value of APP_ICON.
        - The function sets both the small and big icons for the window.
    """
