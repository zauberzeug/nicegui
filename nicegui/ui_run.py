...
def run(*,
        ...
        protocol: Optional[Union[None, Literal['http', 'https']]] = None,
        **kwargs: Any,
        ) -> None:
    """ui.run
    ...
    :param protocol: start the server using the 'http' or 'https' protocol. If None, determined by presence of uvicorn kwargs `ssl_certfile` and `ssl_keyfile`.
    ...
    if protocol is None:
        if 'ssl_certfile' in kwargs and 'ssl_keyfile' in kwargs:
            protocol = 'https'
        else:
            protocol = 'http'
