...
def run(*,
        ...
        require_main_process: bool = True,
        **kwargs: Any,
        ) -> None:
    """ui.run
    ...
    :param require_main_process: exit immediately if not on main process (default: `True`)
    ...
    if require_main_process and (multiprocessing.current_process().name != 'MainProcess'):
        return
