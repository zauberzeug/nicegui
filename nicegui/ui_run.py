...
def run(*,
    ...
    :param on_air: tech preview: [allows temporary remote access ](https://nicegui.io/documentation/section_configuration_deployment#nicegui_on_air) if set to `True` (default: disabled)
