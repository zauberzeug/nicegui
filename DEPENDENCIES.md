...
- dompurify: 3.4.13 ([MPL-2.0](https://opensource.org/licenses/MPL-2.0) or [Apache-2.0](https://opensource.org/licenses/Apache-2.0))
...
- mermaid: 11.16.1 ([MIT](https://opensource.org/licenses/MIT))
- plotly.js: 3.1.1 ([MIT](https://opensource.org/licenses/MIT))
- three: 0.184.0 ([MIT](https://opensource.org/licenses/MIT))
